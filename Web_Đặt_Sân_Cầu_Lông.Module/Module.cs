...
namespace Web_Đặt_Sân_Cầu_Lông.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class Web_Đặt_Sân_Cầu_LôngModule : ModuleBase {
    public Web_Đặt_Sân_Cầu_LôngModule() {
		// 
		// Web_Đặt_Sân_Cầu_LôngModule
		// 
